"""
Django settings for almastudio project.
...
ALLOWED_HOSTS = ['almastudio.herokuapp.com','127.0.0.1','lab4django.herokuapp.com']
#ALLOWED_HOSTS = ['*']
...
WSGI_APPLICATION = 'almastudio.wsgi.application'
